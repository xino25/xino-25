<script>
	...
	import athenaLogo from '$lib/assets/sponsors/athena.png';
    import prodotLogo from '$lib/assets/sponsors/prodot.png';
    import xyzLogo from '$lib/assets/sponsors/xyz.png';
	...
	const contactInfo = [
		...
		{ 
			label: "Discord",
			info: "discord.gg/xino", 
			href: "https://discord.gg/xino",
			icon: "logo-discord"
		}
	];
	...
	const downloadsInfo = [
		...
		},
		{
			...
			href: "/xcrypt_invite.pdf",
			icon: "cloud-download-outline"
		},
		{
			label: "Gallery - XINO 25",
			href: "/gallery",
			icon: "open-outline"
		}
	];
			...
			<div class="relative rounded-xl overflow-hidden w-full">
				...
				<div class="relative p-8 text-center">
					...
					<p class="text-white/80 text-lg mb-8">
						11:59, 2nd October – 23:59, 3rd October
					</p>
					<div class="flex gap-4 justify-center">
						<a class="bg-emerald-600 hover:bg-emerald-700 hover:scale-105 text-white px-6 py-2 rounded-full font-semibold transition-all duration-200 flex justify-center items-center" href="/register">
							Register
						</a>
