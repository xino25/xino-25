<script>
	...
	const events = [
		...
		{
			name: "Xquisite",
			description: "Creative and artistic expression competition",
			type: "Creative",
		...
		{
			name: "Xclusive",
			description: "Mystery surprise event with unexpected challenges",
			type: "Surprise",
		...
		{
			name: "XFrame",
			description: "Online film making and video production competition",
			type: "Film Making",
		...
		{
			name: "XCrypt",
			description: "Cryptic hunt with puzzles and hidden clues",
			type: "Cryptic Hunt",
	...
	onMount(() => {
		// No image preloading needed for gradient backgrounds
	});
